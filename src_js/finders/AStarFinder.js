...
Qt.include("../core/heap.js")
Qt.include("../core/Util.js")
Qt.include("../core/Heuristic.js")
var DiagonalMovement = Qt.include("../core/DiagonalMovement.js")
    ...
    while (!openList.empty()) {
        ...
        for (i = 0, l = neighbors.length; i < l; ++i) {
            ...
            if (!neighbor.opened || ng < neighbor.g) {
                neighbor.g = ng;
                neighbor.h = neighbor.h || weight * Heuristic.manhattan(abs(x - endX), abs(y - endY));
